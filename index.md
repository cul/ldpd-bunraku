...
The online Bunraku gallery is divided into [plays]({{ site.baseurl }}/plays/), [productions]({{ site.baseurl }}/productions/), [authors]({{ site.baseurl }}/authors/), [kashira]({{ site.baseurl }}/kashira/) (puppets), [characters]({{ site.baseurl }}/characters/), [performers]({{ site.baseurl }}/performers/), and [image tags]({{ site.baseurl }}/tags/), and even includes data on individual [performances]({{ site.baseurl }}/performances/7/) and  [scenes]({{ site.baseurl }}/scenes/14/). It documents the form's revival in the second half of the 20th century, through more than 12,500 digitized slides and nearly 7,000 black-and-white photographs of rehearsals and performances.

Below is an interactive, hierarchical graph of the structure of just one play: [Oshun and Dembei (Chikagoro kawara no tatehiki / 近頃河原の達引)]({{ site.baseurl }}/plays/6/), including links to its authors and productions in which it was performed, which in turn link to scenes which link to performer information.
