...
The online Bunraku gallery is divided into __[plays]({{ site.baseurl }}/plays/)__, __[productions]({{ site.baseurl }}/productions/)__, __[authors]({{ site.baseurl }}/authors/)__, __[kashira]({{ site.baseurl }}/kashira/)__ (puppets), __[characters]({{ site.baseurl }}/characters/)__, __[performers]({{ site.baseurl }}/performers/)__, and __[image tags]({{ site.baseurl }}/tags/)__, and even includes data on individual __[performances]({{ site.baseurl }}/performances/7/)__ and  __[scenes]({{ site.baseurl }}/scenes/14/)__. It documents the form's revival in the second half of the 20th century, through more than 12,500 digitized slides and nearly 7,000 black-and-white photographs of rehearsals and performances.

__Below is an interactive, hierarchical graph of the structure of just one play: [Oshun and Dembei (Chikagoro kawara no tatehiki / 近頃河原の達引)]({{ site.baseurl }}/plays/6/)__, including links to its authors and productions in which it was performed, which in turn link to scenes which link to performer information.
